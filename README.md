...
spreadsheet you can filter. Each row holds the title, the authors, up to three
grouping categories, the most important point of the paper in the paper's own
words, and a link to the research.
...
```
{
  ...
  "authors": ["First Last"],
  "year": 2026,
  "venue": "the journal or law review, with volume and pages",
...
The safety check enforces all three. Open Terminal, type `cd ` with a space,
